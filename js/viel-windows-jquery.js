...
function Lw(lid, urls, ani) { //leap window
    ...
    $('#lw_content').append('<div class="col-md-12" id="' + lid + '" style="display:none;"><div class="leap_window_border"><div class="leap_window_header"><div style="cursor:pointer;" onclick="lwrefresh(\'' + lid + '\');" id="ref_button_' + lid + '" class="irc_cb" ><span  class="glyphicon glyphicon-refresh viel_glyph hidden-print"></span></div></div><div id="' + lid + '_content" class="row"><div id="' + lid + '_contentdlm" class="col-md-12"></div></div></div></div>');
