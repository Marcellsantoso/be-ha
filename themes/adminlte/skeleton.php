...
if(strtolower($exp[0]) == strtolower($backEndClass)){
    if(strtolower($exp[1]) == "index"){
        include_once 'skeleton--index.php';
        exit();
    }
}
?><!DOCTYPE html>
...
<header class="header hidden-print">
    <div class="logo" style="cursor:pointer;" onclick="document.location='<?=_SPPATH;?>home';">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="#" onclick="openProfile('<?= Account::getMyID(); ?>');"
                                   class="btn btn-default btn-flat"><?= Lang::t('Profile'); ?></a>
                            </div>
                            <div class="pull-right">
                                <a href="<?= _SPPATH.$backEndClass; ?>/logout"
    ...
    <aside id='leftMainmenu' class="left-side sidebar-offcanvas hidden-print">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image" style="cursor:pointer;" onclick="document.location='<?=_SPPATH;?>myprofile';">
                    <? Account::makeMyFoto(); ?>
                </div>
                <div class="pull-left info" style="cursor:pointer;" onclick="document.location='<?=_SPPATH;?>myprofile';">
                    <p><?= Account::getMyName(); ?></p>
                </div>
            </div>
            <? Mold::theme("leftmenu"); ?>
