...
<!-- banner & block -->
    	...
    	<div id="BannerCarousel" class="carousel slide  height-full" data-ride="carousel">
    	 <div class="carousel-inner  height-full">
        	<div class="item active  height-full">
                ...
                <a href="skeleton.php" class="btn btn-default animated fadeInLeftBig">View Products</a> <a href="lookbook.php" class="btn btn-default animated fadeInRightBig">Lookbook</a>
                </div>
            </div>
    ...
    <div class="col-md-6 col-sm-4 height-full">
        <div class="height-full">
            <div class="col-md-6 col-xs-12 height-half animated fadeInUp"><div class="block height-full women "><a href="skeleton.php" class="info animated fadeInDown"><h3>women</h3><span>21459 Products</span></a></div></div>
            ...
            <div class="col-md-6 col-xs-12 height-half animated fadeInDown"><div class="block height-full men"><a href="skeleton.php" class="info animated fadeInDown"><h3>men</h3><span>1874 Products</span></a></div></div>
            <div class="col-md-6 col-xs-12 height-half animated fadeInUp"><div class="block height-full couple"><a href="skeleton.php" class="info animated fadeInDown"><h3>Gifts</h3><span>398 Products</span></a></div></div>
        </div>
    </div>
