...
?>
<div id="PageAddPage_content"
     class="row">
<div id="PageAddPage_contentdlm"
     class="col-md-12">
<div id="resultme"></div>
<!--
...
<form role="form"
      method="post"
      action="<?= _SPPATH; ?>PageWeb/Page?cmd=add"
      id="editform_Page_<?= $t; ?>">
<?
if ($load) {
	?>
...
<input type="hidden"
       name="post_modified"
       value="<?= $obj->post_modified; ?>"
       id="post_modified"
       class="form-control">

<!--<div class="form-group">-->
<!--	<label for="post_image"-->
<!--	       class="col-sm-2 control-label">--><?//= Lang::t('post_image'); ?><!--</label>-->
<!---->
<!--	<div class="col-sm-10">-->
<!--		--><?//
...
<!--		      id="warning_post_image"></span>-->
<!--</div>-->
<div id="formgroup_post_title"
     class="form-group">
	<label for="post_title"
	       class="col-sm-2 control-label"><?= Lang::t('post_title'); ?></label>
	...
	<div class="col-sm-10">
		<input type="text"
		       ...
		       class="form-control">
			<span class="help-block"
			      id="warning_post_title"></span>
	</div>
</div>

<div id="formgroup_post_content"
     class="form-group">
	<label for="post_content"
	       class="col-sm-2 control-label"><?= Lang::t('post_content'); ?></label>

	<div class="col-sm-10">
		<textarea class="form-control"
		          rows="10"
		          name="post_content"
		          id="post_content<?= $t; ?>"><?= stripslashes($obj->post_content); ?></textarea>
			<span class="help-block"
			      id="warning_post_content"></span>
	</div>
</div>
<script>
...
<div id="formgroup_post_status"
     class="form-group">
	<label for="post_status"
	       class="col-sm-2 control-label"><?= Lang::t('post_status'); ?></label>
	...
	<div class="col-sm-10">
		<select name="post_status"
			...
			<option value="publish" <? if ($obj->post_status == "publish") {
				echo "selected";
			} ?>><?= Lang::t('publish'); ?></option>

		</select>

			<span class="help-block"
			      id="warning_post_status"></span>
	</div>
</div>

<!--<div id="formgroup_post_files"-->
<!--     class="form-group">-->
<!--	<label for="post_files"-->
<!--	       class="col-sm-2 control-label">--><?//= Lang::t('post_files'); ?><!--</label>-->
<!---->
<!--	<div class="col-sm-10">-->
<!--		--><?//
...
//		?>
<!--		<span class="help-block"-->
<!--		      id="warning_post_files"></span>-->
<!--	</div>-->
<!--</div>-->

<div style="display:none;">

	<div id="formgroup_post_webtitle"
	     class="form-group">
		<label for="post_webtitle"
		       class="col-sm-2 control-label"><?= Lang::t('post_webtitle'); ?></label>

		<div class="col-sm-10">
			<input type="text"
			       name="post_webtitle"
			       value="<?= $obj->post_webtitle; ?>"
			       id="post_webtitle"
			       class="form-control">
				<span class="help-block"
				      id="warning_post_webtitle"></span>
		</div>
	</div>

	<div id="formgroup_post_webmetakey"
	     class="form-group">
		<label for="post_webmetakey"
		       class="col-sm-2 control-label"><?= Lang::t('post_webmetakey'); ?></label>

		<div class="col-sm-10">
			<input type="text"
			       name="post_webmetakey"
			       value="<?= $obj->post_webmetakey; ?>"
			       id="post_webmetakey"
			       class="form-control">
				<span class="help-block"
				      id="warning_post_webmetakey"></span>
		</div>
	</div>

	<div id="formgroup_post_metadesc"
	     class="form-group">
		<label for="post_metadesc"
		       class="col-sm-2 control-label"><?= Lang::t('post_metadesc'); ?></label>

		<div class="col-sm-10">
			<input type="text"
			       name="post_metadesc"
			       value="<?= $obj->post_metadesc; ?>"
			       id="post_metadesc"
			       class="form-control">
				<span class="help-block"
				      id="warning_post_metadesc"></span>
		</div>
	</div>
...
<div class="form-group">
	<div class="col-sm-10">
		<button type="submit"
		        class="btn btn-default"><?= Lang::t('submit'); ?></button>
		<button id="close_button_<?= $formID; ?>"
		        class="btn btn-default"><?= Lang::t('cancel'); ?></button>
		<script>
	...
	$("#editform_Page_<?=$t;?>").submit(function (event) {
		...
		if (!stop) {
			...
			var posting = $.post(url, {
				post_subcon_id: post_subcon_id,
				post_files: post_files,
				post_gallery_id: post_gallery_id,
				post_webtitle: post_webtitle,
				post_webmetakey: post_webmetakey,
				post_metadesc: post_metadesc,
				load: load,
				ID: $('#editform_Page_<?=$t;?> #ID').val(),
				post_title: title,
				post_content: data1,
				post_status: status,
				post_author: $('#editform_Page_<?=$t;?> #post_author').val(),
				post_date: post_date,
