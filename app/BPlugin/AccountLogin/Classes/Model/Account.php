...
class Account extends Model {
    ...
    //Default Coloms
    var $default_read_coloms = 'admin_id,admin_username,admin_nama_depan,admin_password,admin_role,admin_aktiv';
    ...
    var $coloumlist = "admin_username,admin_password,admin_lastupdate,admin_aktiv,admin_email,admin_role";
    ...
    public static function printFoto ($src, $size)
    {
        ...
        if ($size == "responsive") {
            ?>
            <div class="foto<?= $size; ?>">
                <img src="<?=_SPPATH. $src; ?>" class="<?= $classname; ?>" style="width: 100%;">
            </div>
        <?
        } else {
            ?>
            ...
            <div class="foto<?= $size; ?>">
                <img src="<?= _SPPATH.$src; ?>" class="<?= $classname; ?>" onload="OnImageLoad(event,<?= $size; ?>);">
            </div>
        <?
        }
    }
