...
class BootstrapUX {
    ...
    public static function createModal($modalTitle,$modalLoadContentURL,$glyphicons = "glyphicon glyphicon-plus"){
        $t = time();
        ?>
<i style="cursor:pointer;"  data-toggle="modal" data-target="#myModal" onclick="modalfkt_<?=$t;?>();" class="<?=$glyphicons;?>"></i>
